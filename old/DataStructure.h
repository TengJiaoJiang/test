...
#define   LaneRightAfterLeft	(0.5 - LaneWidth)
#define   LaneRightAfterRight	(0.5)
#define   LaneCloseLeft			(0.5)
#define   LaneCloseRight		(0.5 + LaneWidth)
#define   LaneCloseNearLeft		(0.5 + LaneWidth)
#define   LaneCloseNearRight	(0.5 + LaneWidth * 2)
